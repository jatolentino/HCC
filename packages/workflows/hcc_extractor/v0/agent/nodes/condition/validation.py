...
#     # Simple validation without LLM if we have HCC codes
#     if hcc_codes:
#         # Create set for faster lookup
#         hcc_code_set = set(hcc_codes)
...
#     else:
#         # If no HCC codes provided, use LLM for validation
#         # Convert conditions to string for prompt
#         conditions_str = json.dumps(raw_conditions, indent=2)
#         hcc_codes_str = "No HCC codes provided"
        
#         # Use LLM to validate
#         validated: List[ValidatedConditionSchema] = call_llm(
#             prompt_template=hcc_validation_prompt,
#             input_parameters={
#                 "conditions": conditions_str,
#                 "hcc_codes": hcc_codes_str
#             },
#             pydantic_object=List[ValidatedConditionSchema]
#         )
