"""
Utility function for creating generic LangChain chains.
"""
...
def create_generic_chain(
    ...
    **kwargs: Any,
    ...
    """
    Create a generic LangChain processing chain.
    
    Args:
        chat_model: The LLM to use
        template: The prompt template
        pydantic_class: Optional Pydantic class for output parsing
        **kwargs: Additional parameters for the template
        
    Returns:
        ChatPromptTemplate: The configured chain
    """
